...
class FinalExamMarks(models.Model):
    ...
    studentid = models.ForeignKey('Students', models.DO_NOTHING, db_column='StudentID')  # Field name made lowercase.
    classroomid = models.ForeignKey(Classrooms, models.DO_NOTHING, db_column='ClassroomID')  # Field name made lowercase.
    roll_no_field = models.IntegerField(db_column='Roll No.')  # Field name made lowercase. Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
    subject_name = models.CharField(db_column='Subject Name', max_length=30)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    subject_marks = models.IntegerField(db_column='Subject Marks')  # Field name made lowercase. Field renamed to remove unsuitable characters.
